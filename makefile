...
obj/tree.o: src/tree.c src/tree.h src/strtab.h | obj
	$(CC)  $(CFLAGS) -c $< -o $@

obj/driver.o: src/driver.c src/tree.h obj/y.tab.h src/strtab.h src/codegen.h | obj
	$(CC)  $(CFLAGS) -c $< -o $@
